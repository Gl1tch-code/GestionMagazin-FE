...
$(function () {
 ...
 Morris.Bar({
    ...
    data: [
        { y: 'BOÎTE ARCHIVE EN PLASTIQUE 6CM', a: 100 },
        { y: 'CHEMISE À BULLE JAUNE', a: 75 },
        { y: 'ENCRE DE PHOTOCOPIEUR KONICA MINOLTA', a: 50 },
        { y: 'CACHES COMPOSTEURS', a: 30 },
        { y: 'CHEMISE CARTONNÉE', a: 60 },
        { y: 'TONER', a: 90 },
        { y: 'INTERUPTEUR DOUBLE', a: 40 },
        { y: 'PRISE MURALE', a: 25 },
        { y: 'DISJONCTEUR 16A', a: 45 },
        { y: 'SPOT LED GU10', a: 35 }
    ],
    xkey: 'y',
    ykeys: ['a'],
    labels: ['Quantité'],
